...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <div class="container login-container login-form-2 reg-form">
            ...
            <!-- Birthdate -->
            <div class="form-group">
                <label for="birthDate" class="col-sm-3 text-white control-label">Date of Birth*</label>
                <div class="col-sm-4">
            ...
            <!-- Phone Number -->
            <div class="form-group">
                <label for="phoneNumber" class="col-sm-3 text-white control-label">Phone number* </label>
                <div class="col-sm-4">
        ...
        <!-- Fields that need to be filled in displayed to user -->
            <div class="form-group">
