<%@ Page Title="" Language="C#" MasterPageFile="../PageHeader.Master" AutoEventWireup="true" CodeBehind="UpdateProduct.aspx.cs" Inherits="BobbleButt.Update" %>
    ...
    <div class="container login-container login-form-2 reg-form">
            ...
            <div class="form-group">
               <!-- Text box created which is product name takes up 6 coloumns out of 12 -->
                <div class="col-sm-6">
                    <asp:TextBox runat="server"  id="productUpdateName" placeholder="Product Name"  class="form-control" MaxLength="40"/>
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    <asp:TextBox runat="server" id="productUpdateStock" placeholder="Product Stock" class="form-control" MaxLength="7"/>
                    <!-- Validators -->
                    ...
                    <asp:RegularExpressionValidator Display="Dynamic" ID="regexStockUpdate" CssClass="label-error" runat="server" ValidationExpression="^\d+$" ControlToValidate="productUpdateStock" ErrorMessage="Stock must be a number "></asp:RegularExpressionValidator>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-9">
                    <asp:TextBox runat="server" id="productUpdateDescription" TextMode="MultiLine" Rows="4" placeholder="Product Description" class="form-control"/>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    <asp:TextBox runat="server" id="productUpdatePrice" placeholder="Product Price" class="form-control" MaxLength="9"/>
                    <!-- Validators -->
                    ...
                    <!-- 
                        Author: rtbHarry 
                        Url https://forums.asp.net/t/1552247.aspx?Regular+Expression+to+get+Price
                        Title: Forums Asp.Net 
                        Date: 07/06/19
                        Used: Get price with decimals or without
                    -->
                    <asp:RegularExpressionValidator Display="Dynamic" ID="regexPriceUpdate" CssClass="label-error" runat="server" ValidationExpression="^\$?(\d{1,3}(\,\d{3})*|(\d+))(\.\d{2})?$" ControlToValidate="productUpdatePrice" ErrorMessage="Price must be a number "></asp:RegularExpressionValidator>
                </div>
            </div>
