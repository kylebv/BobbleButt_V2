...
<body class="blue">
    ...
    <div class="container login-container login-form-1">
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator Display="Dynamic" ID="regexState" CssClass="label-error" runat="server" ValidationExpression="([nN][sS][wW]|[aA][cC][tT]|[qQ][lL][dD]|[sS][aA]|[wW][aA]|[vV][iI][cC]|[tT][aA][sS]|[nN][tT])" ControlToValidate="state" ErrorMessage="Invalid State"></asp:RegularExpressionValidator>
