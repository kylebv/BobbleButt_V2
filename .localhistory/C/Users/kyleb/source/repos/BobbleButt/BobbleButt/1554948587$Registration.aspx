    ...
    <div class="container login-container login-form-1 reg-form">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <asp:CompareValidator ID="valBirthDate" Operator="GreaterThan" CssClass="label-error" type="String" ControltoValidate="birthDate" ErrorMessage="Birth date is invalid" runat="server" />
            </div>
            <div class="form-group">
