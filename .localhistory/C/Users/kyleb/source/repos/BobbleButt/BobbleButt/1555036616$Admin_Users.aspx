...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <div class="toolbar hidden-print">
        <div class="text-right">
            <button id="printitemlist" class="btn btn-info"><i class="fa fa-print"></i> Print</button>
        ...
        <div style="min-width: 600px">
            ...
            <main>
                <div class="row contacts">
                    <div class="col itemlist-to">
                        <div class="text-gray-light">itemlist TO:</div>
                        <h2 class="to">John Doe</h2>
                        <div class="address">796 Silver Harbour, TX 79273, US</div>
                        <div class="email"><a href="mailto:john@example.com">john@example.com</a></div>
                    </div>
                    <div class="col itemlist-details">
                        <h1 class="itemlist-id">itemlist 3-2-1</h1>
                        <div class="date">Date of itemlist: 01/10/2018</div>
