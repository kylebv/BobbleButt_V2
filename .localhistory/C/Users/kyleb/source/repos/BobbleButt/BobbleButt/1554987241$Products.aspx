...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    { %>
                            ...
                            <asp:Button runat="server" Enabled="false" OnClick="btnCart_Click" Text="Add to Cart" ID="<%=GlobalData.productList.IndexOf(p) %>" class="btn btn-success shadow btn-block"/>
                                </div>
                            <%} %>
