...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <div class="container login-container login-form-1 reg-form">
        ...
        <div class="form-group">
                ...
                <div class="col-sm-5">
                    <asp:TextBox runat="server" enabled="false" id="email" placeholder="Email" class="form-control" />
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="form-group">
                        <label class="ForgetPwd">Registered as Admin?</label>
                        <asp:CheckBox runat="server" Enabled="false" CssClass="btn" id="chkAdmin"/>
                        </div>
