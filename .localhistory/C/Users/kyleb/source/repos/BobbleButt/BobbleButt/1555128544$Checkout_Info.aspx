        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Shipping address</h4>
            ...
            <div class="mb-3">
              ...
              <asp:TextBox runat="server" TextMode="Email" maxlength="10" class="form-control" id="phone" placeholder="0412345678 *"/>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <asp:TextBox runat="server" class="form-control" id="card_number" placeholder="" />
                  <asp:RequiredFieldValidator ID="valCardNumber" Display="Dynamic" CssClass="label-error" ErrorMessage="Please enter a card #" runat="server" controltovalidate="card_number"/>
                                  <asp:RegularExpressionValidator Display="Dynamic" ID="regexCardNumber" CssClass="label-error" runat="server" ValidationExpression="^[0-9]{12}$" ControlToValidate="card_number" ErrorMessage="Invalid Card Number"></asp:RegularExpressionValidator>
            ...
            <div class="row">
              <div class="col-md-3 mb-3">
                ...
                <asp:TextBox runat="server" class="form-control" id="card_expiration" placeholder="" />
                  <asp:RequiredFieldValidator ID="valCardExpiration" Display="Dynamic" CssClass="label-error" ErrorMessage="Please enter an expiration date" runat="server" controltovalidate="card_expiration"/>
                                                    <asp:RegularExpressionValidator Display="Dynamic" ID="regexCardExpiration" CssClass="label-error" runat="server" ValidationExpression=" /(\d){2}\/(\d){2}/" ControlToValidate="card_expiration" ErrorMessage="Invalid Date Format (mm/yy)"></asp:RegularExpressionValidator>
