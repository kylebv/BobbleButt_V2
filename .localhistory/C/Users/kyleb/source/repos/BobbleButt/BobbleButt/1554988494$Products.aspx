                ...
                <div class="col-12 col-md-6 col-lg-4 card-deck pad-from-footer">
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <button type="submit"  value="Add to Cart" onclick="window.location.href=Products.aspx?addItem=<%= GlobalData.productList.IndexOf(p) %>" class="btn btn-success shadow btn-block"/>
                                <%}
    else
    { %>
