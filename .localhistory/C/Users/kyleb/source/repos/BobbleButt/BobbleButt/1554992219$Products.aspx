            ...
            <div class="card bg-light mb-3">
                ...
                <ul class="list-group category_block">
                    <%foreach (string s in GlobalData.categoryList)
                        { %>
                    <li class="list-group-item"><a href="category.html"><%=s %></a></li>
                    <%} %>
                </ul>
            </div>
        ...
        <div class="col">
            <div class="row">
                ...
                <%}
                    ...
                    else if (p.Name.ToLower().Contains(Request.QueryString["search"].ToLower()) || p.Description.ToLower().Contains(Request.QueryString["search"].ToLower()) || p.Category.ToLower().Contains(Request.QueryString["search"].ToLower()))
                    {
