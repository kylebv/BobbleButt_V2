...
<body class="blue">
    ...
    <div class="container login-container login-form-1">
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator Display="Dynamic" ID="regexState" CssClass="label-error" runat="server" ValidationExpression="/^(NSW|ACT|QLD|SA|WA|VIC|TAS|NT)$/" ControlToValidate="state" ErrorMessage="Invalid State"></asp:RegularExpressionValidator>
