...
<body class="blue">
    <form id="form1" runat="server">
       ...
       ValidationGroup="Validate" ControlToValidate="logEmail1"  
       ControlToCompare="logEmail2" ErrorMessage="Emails do not match." SetFocusOnError="true">
</asp:CompareValidator>
                    <asp:CompareValidator 
       ID="comparePasswords" Operator="Equal" runat="server"
       ValidationGroup="Validate" ControlToValidate="logPassword1"  
       ControlToCompare="logPassword2" ErrorMessage="Passwords do not match." SetFocusOnError="true">
</asp:CompareValidator>
