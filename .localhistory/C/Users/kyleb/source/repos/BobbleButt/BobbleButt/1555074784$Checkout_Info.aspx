...
<body class="blue">
    ...
    <div class="container login-container login-form-1 reg-form" id="checkout">
            <ul class="nav nav-pills nav-justified">
                                    <li class="active"><a href="#"><i class="fa fa-map-marker"></i><br/>Address</a></li>
                                    <li class="disabled"><a href="#"><i class="fa fa-money"></i><br/>Billing</a></li>
                                    <li class="disabled"><a href="#"><i class="fa fa-eye"></i><br/>Confirm</a></li>
                                </ul>
        ...
        <asp:RequiredFieldValidator runat="server" controltovalidate="suburb"/>
            ...
            <asp:Button runat="server" class="btn btnSubmit btn-block" Text="Register"/>
        </div> <!-- ./container -->
        </form>
    </body>
</html>
