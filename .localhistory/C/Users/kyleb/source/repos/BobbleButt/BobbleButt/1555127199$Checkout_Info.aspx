          ...
          <h4 class="mb-3">Shipping address</h4>
            ...
            <div class="mb-3">
              ...
              <asp:TextBox runat="server" TextMode="Email" class="form-control" id="payPalEmail" placeholder="you@example.com *"/>
                <asp:RequiredFieldValidator ID="valPaypalEmial" Display="Dynamic" CssClass="label-error" ErrorMessage="Please enter an email address" runat="server" controltovalidate="payPalEmail"/>
              
            </div>
                 <div class="mb-3">
              <label for="payPalPassword">Password</label>
              <asp:TextBox runat="server" TextMode="Password" class="form-control" id="TextBox2" placeholder="*******"/>
                     <asp:RequiredFieldValidator ID="valPayPalPassword" Display="Dynamic" CssClass="label-error" ErrorMessage="Please enter a passworde" runat="server" controltovalidate="payPalPassword"/>
                     </div>
                </div>
            <hr class="mb-4"/>
