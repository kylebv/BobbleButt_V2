          ...
          <h4 class="mb-3">Billing address</h4>
            ...
            <div class="d-block my-3">
              <div class="custom-control custom-radio">
                <asp:radiobutton GroupName="gp"  runat="server" id="credit" class="custom-control-input" checked="true"/>
                <label class="custom-control-label" for="credit">Credit card</label>
              </div>
              <div class="custom-control custom-radio">
                <asp:radiobutton GroupName="gp" runat="server" id="paypal" class="custom-control-input" />
