...
<body class="blue">
    <form id="form1" runat="server">
       ...
       ControlToCompare="regPassword2" ErrorMessage="Passwords do not match." SetFocusOnError="true">
                    ...
                    <asp:RegularExpressionValidator ID="regexEmailValid" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="regEmail1" ErrorMessage="Invalid Email Format"></asp:RegularExpressionValidator>
