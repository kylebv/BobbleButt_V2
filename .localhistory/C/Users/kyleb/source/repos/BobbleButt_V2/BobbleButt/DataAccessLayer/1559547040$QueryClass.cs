    ...
    public class QueryClass
    {
        ...
        public static List<Product> GetProductData()
        {
            ...
            using (SqlConnection connection = new SqlConnection(m_connectionString))
            {
                ...
                string sql = "SELECT p.name, pc.name,[stock],[description],[price],[image],[productID] FROM Product p JOIN ProductCategory pc ON p.productCategoryID=pc.productCategoryID;";
