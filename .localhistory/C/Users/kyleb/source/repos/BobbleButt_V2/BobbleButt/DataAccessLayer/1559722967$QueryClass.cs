...
namespace BobbleButt.DataAccessLayer
{
    public class QueryClass
    {
        ...
        public static User GetUser(String email, String password)
        {
            ...
            {
                // Get all data about product with product category name
                string sql = "select userID, firstName, lastName, email, DOB, password, street, suburb, postcode, phone, isAdmin, isSuspended from [User] where email = '" + email + "' AND password = '" + password + "'";
                using (SqlCommand command = new SqlCommand(sql, connection))
                {
                    connection.Open();
        ...
        public static User GetUser(String email)
        {
            ...
            {
                // Get all data about product with product category name
                string sql = "select userID, firstName, lastName, email, DOB, password, street, suburb, postcode, phone, isAdmin, isSuspended from [User] where email = '" + email + "'";
                using (SqlCommand command = new SqlCommand(sql, connection))
                {
                    connection.Open();
        ...
        public static void AddUser(User u)
        {
            ...
            {
                // Get all data about product with product category name
                string sql = "INSERT INTO [User] (firstName, lastName, email, password, DOB, street, suburb, postcode, phone, isAdmin, isSuspended " +
        ...
        public static void AddProduct(Product p)
        {
            ...
            {
                // Get all data about product with product category name
                string sql = "INSERT INTO  Product (name, stock, description, price, image, isDeleted) " +
                    "VALUES ('"+p.Name+ "', "+p.Stock+ ", '"+p.Description+ "', "+p.Price+ ", '"+p.Image+ "', "+p.IsDeleted+")";
                using (SqlCommand command = new SqlCommand(sql, connection))
                {
                    connection.Open();
                    SqlDataReader reader = command.ExecuteReader();
