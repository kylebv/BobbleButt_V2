                ...
                <div class="col-12 col-md-6 col-lg-4 card-deck pad-from-footer">
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column">
                           <!-- Name of product -->
                           <h4 class="card-title"><a href="/PurchaseProduct.aspx?PassingValue=<%=p.ID-1 %>" title="View Product"><%=p.Name %></a></h4>
                            ...
                            <!-- Add to cart Button -->
                            <button type="submit"  value="Add to Cart" onclick="window.location.href='/Products.aspx?addItem=<%= p.ID-1 %>'; return false" class="btn btn-success shadow btn-block">Add to Cart</button>
                                <%}
